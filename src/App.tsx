...
function App() {
    return (
        <>
            <Header />
            <main className="w-[90%] m-auto flex flex-col gap-10 md:w-[95%]">
                ...
                <section className="border-1 border-gray-200">
                    ...
                    <div className="flex flex-row bg-white gap-3 flex-wrap itens-center justify-left text-[12px] p-2">
                        <a
                        ...
                        <a className="bg-gray-200  p-1 cursor-pointer" href="">
                            New York
                        </a>
                        <a className="bg-gray-200  p-1 cursor-pointer" href="">
                            London
